...
import org.aiagency.utils.ExecutionRecorderUtil;
...
public class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ExecutionRecorderUtil.startRecording();

            // 📸 Init screenshot folder (step-wise screenshots)
            ...
            // 🎥 Stop recording ALWAYS
            ExecutionRecorderUtil.stopRecording();
        }
    }
}
